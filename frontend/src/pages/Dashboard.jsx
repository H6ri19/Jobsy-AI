  ...
  return (
    <DashboardLayout>
      ...
      <Modal
        ...
        showActionBtn
        actionBtnText="Delete"
        actionBtnClassName="bg-red-600"
        onActionClick={handleDeleteResume}
      >
        <div className="text-center p-4">
          <LuTrash2 size={24} className="mx-auto text-red-600" />
          <p className="mt-2">Delete this resume permanently?</p>
        </div>
      </Modal>
    </DashboardLayout>
  );
